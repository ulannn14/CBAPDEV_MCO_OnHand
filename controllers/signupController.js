...
// Helper function for normalizing file paths
...
const signupController = {
  ...
  postSignup: async (req, res) => {
    ...
    try {
      ...
      // Ensure that username, email, and password exists
      ...
      // Declare directories for file upload
      ...
      // Create folder directories if it doesn't exist
      [profileDir, idDir, nbiDir].forEach(dir => {
        if (!fs.existsSync(dir)) fs.mkdirSync(dir, { recursive: true });
      });

      // Helper for saving files to their respective directories
      ...
      // If successful, log in as new user
      if (result) {
...
// Export object 'signupController'
